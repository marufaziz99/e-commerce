...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2020 at 09:16 PM
...
--
ALTER TABLE `tbl_biaya_kirim`
  MODIFY `id_biaya_kirim` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tbl_biaya_kirim`
  ADD CONSTRAINT `tbl_biaya_kirim_ibfk_1` FOREIGN KEY (`id_kota`) REFERENCES `tbl_kota` (`id_kota`),
  ADD CONSTRAINT `tbl_biaya_kirim_ibfk_2` FOREIGN KEY (`id_jasa`) REFERENCES `tbl_kurir` (`id_kurir`);
